...
print("Ingrese ultimo digito de placa de carro # ${contador+1} para saber el color de la calcomania:");
digitoPlaca = int.parse(stdin.readLineSync()!);
while ( digitoPlaca < 0 || digitoPlaca > 9 ) {
print("Rango no valido, debe ser entre 0 y 9 Ingrese de nuevo el digito de carro # ${contador+1}");
digitoPlaca = int.parse(stdin.readLineSync()!);
}
